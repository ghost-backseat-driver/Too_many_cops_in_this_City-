...
{
    [Header("스폰할 캅 프리팹")]
    [SerializeField] private Enemy_Control copPrefab; //임시로 일단 넣어놓음
    ...
    private void Start()
    {
        ...
        GameManager.Pool.CreatePool(copPrefab, startPoolCount);
    ...
    private void SpawnPrefab()
    {
        ...
        MonoBehaviour obj = GameManager.Pool.GetFromPool(copPrefab);
